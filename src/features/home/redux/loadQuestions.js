...
export function loadQuestions(curTest) {
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
     ...
     const doRequest=axios.get(`https://cors-anywhere.herokuapp.com/https://tungtung-sample.herokuapp.com/tests/data/questions/${curTest}`)
      doRequest.then(
        //console.log("https://cors-anywhere.herokuapp.com/https://tungtung-sample.herokuapp.com/tests/data/question/"+`${curTest}`),
        (res) => {
          dispatch({
            type: HOME_LOAD_QUESTIONS_SUCCESS,
            data: res.data[0].questions,
          });
          resolve(res);     
        },
